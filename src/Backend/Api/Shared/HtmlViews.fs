...
let private htmlHead (settings: ITemplateSettings) =
    Html.head [
        ...
        Html.script [
            ...
            prop.src "https://cdn.skypack.dev/pin/@hotwired/turbo@v7.0.0-beta.2-ou6dW2bg0qdKgUED7QEB/min/@hotwired/turbo.js"
        ]
        Html.link [
            prop.rel.stylesheet
